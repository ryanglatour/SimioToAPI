...
{
    internal class UserElementDefinition : IElementDefinition
    {
        ...
        public static readonly Guid MY_ID = new Guid("{9f6e9de3-bf29-46d0-82ef-56043afa39c4}");
    ...
    internal class UserElement : IElement
    {
        IElementData _data;
